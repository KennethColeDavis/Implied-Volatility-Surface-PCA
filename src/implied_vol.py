...
def implied_volatility(price, S, K, T, r, option_type, sigma_low=.00001, sigma_high=5.0):   # arbitrary bounds for volatility
    ...
    try:
        return brentq(objective, sigma_low, sigma_high, maxiter=500)       #brentq is a root-finding algorithm that combines bisection, secant, and inverse quadratic interpolation methodds
    except ValueError:
